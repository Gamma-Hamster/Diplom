...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Для Каждого ТекСтрока Из Товары Цикл
		...
		Если ТекСтрока.Номенклатура = Константы.ВКМ_НоменклатураРаботыСпециалиста.Получить() Тогда
			
			Часы         = Часы + ТекСтрока.Количество;
			ОплатаЗаЧасы = ОплатаЗаЧасы + ТекСтрока.Сумма;
			
		КонецЕсли;
		
	КонецЦикла;
	
	Движения.ВКМ_ЗадолженностьПоРеализацииТоваров.Записывать = Истина;
	
	Движение = Движения.ВКМ_ЗадолженностьПоРеализацииТоваров.Добавить();
	...
	Движение.ЧасыРаботыСпециалиста  = Часы;
	Движение.ОплатаРаботСпециалиста = ОплатаЗаЧасы;
